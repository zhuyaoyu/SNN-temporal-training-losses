...
class learningStat():
    ...
    def add_layer(self):
        self.layerNum += 1
        self.spikeTimeCnt.append(np.zeros(self.T))
        self.gradSumW.append(0)
    ...
    def reset(self):
        ...
        for i in range(self.layerNum):
            self.spikeTimeCnt[i] = np.zeros(self.T)
    ...
    def update(self):
        ...
        self.spikeTimeLog.append(np.stack(self.spikeTimeCnt))
...
class learningStats():
    ...
    def __init__(self, t_train, t_test):
        self.linesPrinted = 0
        self.training = learningStat(t_train)
        self.testing = learningStat(t_test)
