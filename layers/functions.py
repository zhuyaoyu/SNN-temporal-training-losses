...
def initialize(layer, spikes):
    ...
    with torch.no_grad():
        ...
        while high / low >= 1.01:
            ...
            outputs = layer.forward_pass(spikes)
            layer.norm_weight.data /= mid
    ...
    return layer.forward_pass(spikes)
...
if __name__ == '__main__':
    ...
    for key, val in zip(('n_steps', 'lr', 'tau_s', 'tau_m', 'tau_grad', 'threshold'), (T, 0.0005, 7, 4, 3.5, torch.rand(3, device='cuda')+0.5)):
        config[key] = val
